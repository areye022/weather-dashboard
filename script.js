...
function weatherSearch(){
    ...
    //     // adding icons
    var icon = $("<img>").attr("src", "http://openweathermap.org/img/w/" + res.list[i].weather[0].icon + ".png");
     // icon.addClass("image-styling")
        searchWeather.append(icon);
        // iconContainer.append(icon);
    // if (res.list[i].weather[0].main==='Clouds'){
    //     console.log('hi');
    //     var iconContainer=$('<div>');
        
    //     // var icon=$('<img>').attr("src",'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ3bjRqzFjxkmvAWL3ff72-tH8UidJ4UxFzmQ&usqp=CAU' );
    //    
    // }
